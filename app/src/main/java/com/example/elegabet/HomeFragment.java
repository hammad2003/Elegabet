...
public class HomeFragment extends Fragment {
    ...
    private LinearLayout linearColumnelegabet;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        linearColumnelegabet = view.findViewById(R.id.linearColumnelegabet);

        // Configurar OnClickListener para el LinearLayout
        linearColumnelegabet.setOnClickListener(new View.OnClickListener() {
            @Override
